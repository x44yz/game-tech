...
public class EntityEffectBundle
{
    ...
    Actor casterEntityBehaviour = null;
    Item fromEquippedItem = null;
    Item castByItem = null;
    ...
    /// </summary>
    public Actor CasterEntityBehaviour
    {
    ...
    public EntityEffectBundle(EffectBundleSettings settings, Actor casterEntityBehaviour = null)
    {
...
public class EffectManager : MonoBehaviour
{
    ...
    public Missile ColdMissilePrefab;
    public Missile PoisonMissilePrefab;
    public Missile ShockMissilePrefab;
    public Missile MagicMissilePrefab;
    ...
    int[] directStatMods = new int[DStats.Count];
    int[] directSkillMods = new int[DSkills.Count];
    int[] combinedStatMods = new int[DStats.Count];
    int[] combinedStatMaxMods = new int[DStats.Count];
    int[] combinedSkillMods = new int[DSkills.Count];
    int[] combinedResistanceMods = new int[DResistances.Count];
    ...
    Dictionary<ulong, Item> activeMagicItemsInRound = new Dictionary<ulong, Item>();
    Dictionary<ulong, Item> itemsPendingReroll = new Dictionary<ulong, Item>();
    ...
    private void Awake()
    {
        ...
        entityBehaviour = GetComponent<Actor>();
        if (entityBehaviour)
        {
    ...
    public bool SetReadySpell(EntityEffectBundle spell, bool noSpellPointCost = false)
    {
        ...
        (int _, int spellPointCost) = FormulaUtils.CalculateTotalEffectCosts(spell.Settings.Effects, spell.Settings.TargetType, null, spell.Settings.MinimumCastingCost);
    ...
    {
        if (statMods == null || statMods.Length != DStats.Count)
            return;
    ...
    {
        if (skillMods == null || skillMods.Length != DSkills.Count)
            return;
    ...
    public Missile InstantiateSpellMissile(ElementTypes elementType)
    {
    ...
    void StartEquippedItem(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings)
    {
    ...
    void UnequipHeldItem(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings)
    {
    ...
    void UseItem(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings, ItemCollection sourceCollection)
    {
    ...
    void BrokenItem(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings)
    {
    ...
    void MagicRoundCallback(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings)
    {
    ...
    void RerollEffectCallback(IEntityEffect effectTemplate, Item item, EnchantmentSettings settings)
    {
    ...
    bool TryAbsorption(IEntityEffect effect, TargetTypes targetType, Actor casterEntity, out int absorbSpellPointsOut)
    {
        ...
        if (entityBehaviour.IsAbsorbingSpells)
            return true;
    ...
    bool TryEffectBasedAbsorption(IEntityEffect effect, SpellAbsorption absorbEffect, Actor entity)
    {
    ...
    bool TryCareerBasedAbsorption(IEntityEffect effect, Actor entity)
    {
        // Always resists
    ...
    public static void BreakNormalPowerConcealmentEffects(Actor entityBehaviour)
    {
        ...
        if (entityBehaviour.HasConcealment(MagicalConcealmentFlags.BlendingNormal))
            manager.EndIncumbentEffect<ChameleonNormal>();

        // End Invisibility-Normal
        if (entityBehaviour.HasConcealment(MagicalConcealmentFlags.InvisibleNormal))
    ...
    void DoConstantEffects()
    {
        ...
        if (entityBehaviour.CurrentMagicka > entityBehaviour.MaxMagicka)
            entityBehaviour.CurrentMagicka = entityBehaviour.MaxMagicka;
    }
    ...
    void DoMagicRound()
    {
        ...
        {
            foreach (Item item in activeMagicItemsInRound.Values)
            {
