...
/// </summary>
public abstract class BaseEffect : IEntityEffect
{
    #region Fields
    ...
    protected ActorEffect manager = null;
    ...
    /// </summary>
    public virtual void Start(ActorEffect manager, Actor caster = null)
    {
    ...
    /// </summary>
    public virtual void Resume(ActorEffect.EffectSaveData_v1 effectData, ActorEffect manager, Actor caster = null)
    {
        this.manager = manager;
        this.caster = caster;
    ...
    protected Actor GetPeeredEntityBehaviour(ActorEffect manager)
    {
